...
import common.apache_commons.entity.Address;
import common.apache_commons.entity.Customer;
...
public class CommonsBeanUtilsTest {
    ...
    public void testBeanUtils(){
        try {
            CommonsBeanUtilsTest.demoNormalJavaBeans();
            CommonsBeanUtilsTest.demoDynaBeans();
        } catch (Exception e) {
            e.printStackTrace();
        }
