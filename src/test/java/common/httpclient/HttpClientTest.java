...
public class HttpClientTest {
    ...
    public void testHttpClient(){
        //jeesite.session.id	093ee5d09fd843c1a8a9a931dd3ce8a2
        String url = "http://127.0.0.1/ppqa-admin/a/sys/dict/listData";
    ...
    public static String doGet(String url, Map<String, String> param) {
        ...
        try {
            ...
            HttpCookie cookie = new HttpCookie("jeesite.session.id", "093ee5d09fd843c1a8a9a931dd3ce8a2");
            // 创建http GET请求
